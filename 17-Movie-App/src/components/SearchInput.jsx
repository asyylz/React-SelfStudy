...
const SearchInput = () => {
    ...
    const searchUrl = `https://api.themoviedb.org/3/search/movie?api_key=${import.meta.env.REACT_APP_TMDB_KEY}&query=`
  ...
  return (
    <form onSubmit={handleSubmit}  className="flex justify-center p-2 mt-7">
        <input
          type="search"
          name="query"
